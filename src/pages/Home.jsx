...
const categories = [
  { name: 'Torneamento', icon: '⟲', link: '/torneamento', desc: 'Insertos, suportes e barras de mandrilar adequadas para operações de alta complexidade em metal duro.', image: torneamento1 },
  { name: 'Fresamento', icon: '⟡', link: '/fresamento', desc: 'Fresas de topo, facear e disco que asseguram acabamento espelhado e taxas de remoção superiores.', image: fresamento1 },
  { name: 'Furação', icon: '⊙', link: '/furacao', desc: 'Brocas inteiriças e intercambiáveis com geometria otimizada para mínima deflexão direcional.', image: furacao1 },
];

const suppliers = [
  { logo: logoMitsubishi, name: 'Mitsubishi Materials', link: '/catalogo', desc: 'Distribuidor técnico autorizado' },
    ...
    <div className={styles.page}>
      ...
      <section className={styles.hero}>
        ...
        <div className={styles.heroImageArea}>
            <img src={linhaMitsu} alt="Usinagem de Alta Performance" className={styles.heroImg} />
        </div>
      </section>

      {/* =============================================
          WEEKLY PROMOS — Steam-style Pop-up Cards
          ============================================= */}
        ...
        <div className={styles.container}>
          ...
          <div className={styles.processTimeline}>
            {categories.map((cat, i) => (
              <div key={i} className={`${styles.processRow} ${i % 2 !== 0 ? styles.processRowReversed : ''}`}>
                ...
                <div className={styles.processContent}>
                  ...
                  <Link to={cat.link} className={styles.categoryArrow}>Especificações Iniciais</Link>
                </div>
              </div>
            ))}
          </div>
          ...
          <div className={styles.supplierGrid}>
            {suppliers.map((s, i) => (
              <Link to={s.link} key={i} className={styles.supplierCard}>
                <img src={s.logo} alt={s.name} className={styles.supplierLogo} />
                <div>
      ...
      <section className={styles.ctaSection}>
        <div className={styles.container}>
          ...
          <p className={styles.ctaText}>
            Nossa equipe técnica está pronta para atender sua demanda com as melhores condições do mercado.
          </p>
          <div className={styles.ctaButtons}>
            <a href="mailto:recom@recommetalduro.com.br" className={styles.ctaPrimary}>Enviar E-mail</a>
            <a href="https://wa.me/551932332224" target="_blank" rel="noopener noreferrer" className={styles.ctaPhone}>
