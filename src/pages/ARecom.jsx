...
const ARecom = () => {
  return (
    <Layout>
      <SEOHead
        title="A RECOM"
        description="Conheça a história da RECOM Metal Duro. Desde 1990 atuando como distribuidor B2B de ferramentas de alta performance para usinagem em Campinas e região."
        canonicalUrl="https://pedroafonso0102.github.io/recom-final-1/a-recom"
      />
