  ...
  return (
    <Layout>
      <SEOHead
        ...
        description="Distribuidor B2B confiável de ferramentas de corte. Especialistas em usinagem, torneamento, fresamento e furação. Atendimento técnico e humano."
        canonicalUrl="https://pedroafonso0102.github.io/recom-final-1/"
        structuredData={{
          "@context": "https://schema.org",
          "@type": "Organization",
          "name": "RECOM Metal Duro",
          "url": "https://pedroafonso0102.github.io/recom-final-1/",
          "logo": "https://pedroafonso0102.github.io/recom-final-1/assets/images/logo_mitsubishi.png",
          "contactPoint": {
            "@type": "ContactPoint",
      ...
      <div className={styles.heroBanner}>
        ...
        <div className={styles.heroContent}>
          ...
          <div className={styles.heroActions}>
            ...
            <Link to="/fornecedores-catalogos" className={styles.secondaryBtn}>Ver Soluções</Link>
          </div>
        </div>
      </div>
      ...
      <div className={styles.centerData}>
        ...
        <div className={styles.sectionBox}>
          ...
          <div className={styles.produtosGrid}>
            <Link to="/fornecedores-catalogos" className={styles.produtoCard}>
