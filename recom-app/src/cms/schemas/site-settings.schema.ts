...
export const siteSettingsSchema = z.object({
  company: z.object({
    ...
    shortName: z.string().trim().min(2, "O nome curto deve ter pelo menos 2 caracteres."),
  ...
  seo: z.object({
    defaultTitle: z.string().trim().min(5, "Título SEO deve ser mais descritivo."),
    defaultDescription: z.string().trim().min(10, "Descrição SEO deve ser mais detalhada."),
