...
export default async function SobrePage() {
  const [settings, suppliers, processes, cmsPage] = await Promise.all([
    getSiteSettings(),
    getSuppliers(),
    getProcesses(),
    getPageBySlug("sobre")
            ...
            <div className="grid grid-cols-1 items-start gap-12 lg:grid-cols-2 lg:gap-20">
              <div className="space-y-8">
                ...
                <div className="space-y-6 pt-4">
                  <h3 className="border-l-4 border-recom-red pl-4 text-[11px] font-bold uppercase tracking-tight text-recom-blue uppercase tracking-[0.2em]">
